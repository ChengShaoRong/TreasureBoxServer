...
namespace TreasureBox
{
    public class ItemJSON
    {
        ...
        /// </summary>
        /// <returns>ItemJSON object</returns>
        public static ItemJSON Get(int id) => (IsInitialized ? (KissJson.Get(_type_, id.ToString()) as ItemJSON) : null);
        /// <summary>
        ...
        /// <summary>
        /// Get ItemJSON object by key that from `GetKeys()`.
        /// </summary>
        /// <param name="key">The key from `GetKeys()`</param>
        /// <returns>ItemJSON object</returns>
        public static ItemJSON GetByKey(string key) => (IsInitialized ? (KissJson.Get(_type_, key) as ItemJSON) : null);
        /// <summary>
        ...
        /// <summary>
        /// Synchronous initialize ItemJSON.
        /// Normally you don't need to call this manually.
        /// </summary>
        public static bool InitializeSynchronous()
        {
            KissJson.Load((object)_type_, System.Environment.CurrentDirectory + "/KissJson/ItemJSON.json");
            _IsInitialized_ = true;
            return true;
        }
        /// <summary>
        /// It's for you can reload ItemJSON from web. 
        /// e.g. you modified the ItemJSON file and want to reload that JSON file while the server is running..
        /// </summary>
        /// <param name="ip"></param>
        /// <returns></returns>
        [WebMethod]
        public static string ReloadItemJSON(string ip)
        {
            Logger.LogInfo($"ReloadItemJSON from {ip}");
        ...
        static System.Type _type_ = typeof(ItemJSON);
